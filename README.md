...
YinegelOS Basic Calc is YinegelOS's Calculator. This application comes bundled with YinegelOS. Also, since this is a new project, only the Turkish language option is available. This application is written in Python. Its dependencies are: customtkinter, python 3.1x
...
`pyinstaller --onefile --windowed "YinegelOS Basic Calc.py"`
